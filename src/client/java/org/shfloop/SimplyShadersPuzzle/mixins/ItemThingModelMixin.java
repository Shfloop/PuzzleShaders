...
public abstract class ItemThingModelMixin implements IPuzzleItemModel {
    ...
    public void renderAsHeldItem(Vector3 pos, Camera handCam, float popUpTimer, float maxPopUpTimer, float swingTimer, float maxSwingTimer)  {
        ...
        if (((finalforeach.cosmicreach.rendering.items.ItemThingModel)(Object)this).isTool()) {
        ...
        ((finalforeach.cosmicreach.rendering.items.ItemThingModel)(Object)this).renderGeneric(pos, heldItemCamera, tmpHeldMat4, false);
